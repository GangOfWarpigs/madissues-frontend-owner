    ...
    <div class="flex flex-col justify-between h-full">
      <div class="flex flex-col gap-3">
        <div class="flex items-center mb-8 gap-5">
          <img
            width="42"
            :src="baseUrl + '/media/organizations/' + data?.logo"
            class="rounded-full"
          />
        ...
        <router-link
          ...
          class="text-gray-400 hover:bg-gray-200 hover:text-gray-600 px-4 py-3 rounded-xl cursor-pointer font-semibold flex gap-3 items-center"
        >
        ...
        <router-link
          :to="{ name: 'teachers' }"
          active-class="!bg-red-500 !text-white "
          class="px-4 py-3 hover:bg-gray-200 hover:text-gray-600 rounded-xl cursor-pointer font-semibold flex gap-3 items-center text-gray-400"
        >
